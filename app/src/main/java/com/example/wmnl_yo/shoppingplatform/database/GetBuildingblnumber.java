...
public class GetBuildingblnumber extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getBuildingblnumber...");
        String url = Constants.SERVER_URL + "getBuildingblnumber.php";
    ...
    protected void onPostExecute(String s) {
        if (s != null) {
            Log.d("55125", s);
            ShoppingPaymentFragment.bl_number = s.trim();
        }
    }
}
