...
public class GetShoppingListBuilding extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        if (s != null) {
            ...
            String[] shoppingObjectAll_student = new String[shoppingObjectAll.length - 1];
            ...
            for (int i = 0; i < shoppingObjectAll.length - 1; i++) {
                ...
                shoppingObjectAll_student[j] = shoppingMallAllInf[7];
                ...
                j++;
                Log.d("55125", j + ":"  + shoppingMallAllInf[1]+","+shoppingMallAllInf[2]+","+shoppingMallAllInf[3]+","+shoppingMallAllInf[4]+","+shoppingMallAllInf[5]+","+shoppingMallAllInf[7]+","+shoppingMallAllInf[6]+","+shoppingMallAllInf[8]+",0");
            }
