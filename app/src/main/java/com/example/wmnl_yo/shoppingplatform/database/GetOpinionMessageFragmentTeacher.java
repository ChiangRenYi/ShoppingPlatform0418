...
import com.example.wmnl_yo.shoppingplatform.fragment.OpinionMessageAddFragmentTeacher;
import com.example.wmnl_yo.shoppingplatform.fragment.OpinionMessengerFragmentTeacher;
...
import static com.example.wmnl_yo.shoppingplatform.fragment.OpinionMessageAddFragmentTeacher.mopinionmessageList;

/**
 * Created by Sandy on 2017/8/30.
 */

public class GetOpinionMessageFragmentTeacher extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "getOpinionMessageFragmentTeacher...");
        String url = Constants.SERVER_URL + "getOpinionMessageFragmentTeacher.php";
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    .appendQueryParameter("AU_Id", OpinionMessengerFragmentTeacher.AUId.trim())
                    .appendQueryParameter("ER_Id", OpinionMessengerFragmentTeacher.ERId.trim())
                    .appendQueryParameter("OM_Text", OpinionMessengerFragmentTeacher.OMText.trim())
                    .appendQueryParameter("OM_Date", OpinionMessengerFragmentTeacher.OMDate.trim())
                    .appendQueryParameter("OM_Time", OpinionMessengerFragmentTeacher.OMTime.trim());
...
//            }
    ...
    protected void onPostExecute(String s) {
        ...
        if (s != null) {
            ...
            OpinionMessageAddFragmentTeacher.oAdapter.notifyDataSetChanged();
        }
