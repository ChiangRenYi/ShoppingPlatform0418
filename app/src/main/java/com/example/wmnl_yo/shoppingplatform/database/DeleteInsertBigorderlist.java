...
public class DeleteInsertBigorderlist extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        Log.d("55125", "deleteInsertBigorderlist...");
        String url = Constants.SERVER_URL + "delete_insert_bigorderlist.php";
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    .appendQueryParameter("bto_id", ShoppingPaymentFragment.bigorderlistnumber);
            Log.d("55125",ShoppingPaymentFragment.bigorderlistnumber);
